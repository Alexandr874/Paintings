...
/* harmony import */ var _modules_scroling__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/scroling */ "./src/js/modules/scroling.js");
/* harmony import */ var _modules_scroling__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_modules_scroling__WEBPACK_IMPORTED_MODULE_12__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_changeFormState__WEBPACK_IMPORTED_MODULE_7__["default"])(calcState);
  ...
  _modules_scroling__WEBPACK_IMPORTED_MODULE_12___default()('.pageup');
});
...
/* harmony default export */ __webpack_exports__["default"] = (accordion); // 1 способ
...
/* harmony default export */ __webpack_exports__["default"] = (changeFormState); //Эта функция представляет собой обработчик событий изменения состояния формы на странице. Она принимает в качестве
...
// 3 способа фильтрации галереи, 3ий самый оптимизированный в самом низу(и к нему коментарии)!
...
/* harmony default export */ __webpack_exports__["default"] = (filter); //ДОКУМЕНТАЦИЯ 
...
/* harmony import */ var _servises_requests__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../servises/requests */ "./src/js/servises/requests.js");
...
var forms = function forms(state) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      console.log(item.files[0]); // устанавливаем новую переменную, она будет отвечать за название файла, который мы будем 
      // помещать на страницу, а конкретно за его колличство симвалов, потому что название файла 
      // может быть очень длинным

      var dots;
      item.files[0].name.split('.')[0].length > 5 ? dots = "..." : dots = '.'; // в этом выражении мы проверяем имя файла(item.files[0].name),после чего при помощи метода 
      ...
      var name = arr[0].substring(0, 5) + dots + arr[1]; // после того, как мы сформировали название файла, нам необходимо вставить его в элемент, который находится выше 
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); // Сделали общий блок в который будут входить блоки с картинками и текстом
      ...
      }, 400); //вводим новую переменную, которая будет отвечать за картинки
      ...
      var api; //при помощи метода (closest) проверяем есть ли такой блок, и отдаем днанные на определённый сервер
      ...
      console.log(api);
      Object(_servises_requests__WEBPACK_IMPORTED_MODULE_14__["postData"])(api, formData) // подставляем переменную (api), потому что у нас не один сервер, а несколько
      .then(function (res) {
        console.log(res);
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      // let scrollHeight -вынесли специально, для старых браузеров!
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  var blocks = document.querySelectorAll(imgSelector); // Функция для отображения изображения с эффектом масштабирования

  function showImg(block) {
    // Находим элемент с изображением внутри блока
    var img = block.querySelector('img'); // Изменяем исходное изображение на другое (добавляем к имени файла "-1.png")

    img.src = img.src.slice(0, -4) + '-1.png'; // Скрываем все параграфы, кроме тех, которые имеют класс "sizes-hit"
  ...
  function hideImg(block) {
    // Находим элемент с изображением внутри блока
    var img = block.querySelector('img'); // Возвращаем исходное изображение (удаляем "-1" из имени файла)

    img.src = img.src.slice(0, -6) + '.png'; // Отображаем все параграфы
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_servises_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStyles); // Решение задачи, если все стили  присудствуют в 
// в html документе
